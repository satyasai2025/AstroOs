...
class ConfluenceEvaluateRequest(BaseModel):
    ...
    target_start_date: datetime | date = Field(..., description="Start date for confluence evaluation")
    target_end_date: datetime | date = Field(..., description="End date for confluence evaluation")
