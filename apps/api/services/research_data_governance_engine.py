...
class ResearchDataGovernanceEngine:
    ...
    def _initialize_governed_datasets(self) -> None:
        ...
        audit4 = DatasetQualityAuditReport(
            ...
            label_leakage_detected=False,
            coordinate_integrity_verified=True,
            audit_summary="Research bio dataset baseline. Duplicates cleaned. External live sync: NOT_AVAILABLE (Offline cache active).",
            status=DatasetQualityStatus.DUPLICATES_REMOVED,
        )
        self._datasets[ds4_id] = GovernedDatasetMetadata(
            dataset_id=ds4_id,
            name="Research Cohort Public Bio Mirror (Offline Baseline)",
            version="1.0.0",
            ...
            positive_count=260,
            negative_count=240,
            source_attribution="Research Bio Dataset Archive (Offline Ingestion)",
