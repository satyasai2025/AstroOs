"""
Unified P1 -> P23 End-to-End Continuous Pipeline Integration Test

Executes a single continuous execution pipeline proving that all 23 Priorities
...
def test_unified_p1_to_p23_continuous_pipeline():
    """
    Executes a single continuous pipeline asserting every priority from P1 to P23.
    """
    # ── P1: EphemerisWrapper ──────────────────────────────────────────────────
    ...
    exp_container = exp_reg.create_experiment(
        ...
        description="Continuous E2E P1-P23 verification experiment",
    ...
    print("\n=======================================================")
    print("ALL P1 -> P23 CONTINUOUS PIPELINE TESTS PASSED 100%!")
    print("=======================================================")
