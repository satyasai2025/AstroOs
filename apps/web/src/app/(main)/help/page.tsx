...
const FEATURE_GUIDES: FeatureGuide[] = [
  ...
  },
  {
    ...
    title: "Sarvatobhadra Chakra (SBC) & 112 Sukshmamshas",
    category: "predictive",
    categoryLabel: "Predictive & Timing",
    route: "/charts/sbc",
    icon: "grid",
    tagline: "Classical 9x9 concentric grid with 112 Sukshmamshas, 28 Nakshatras & multi-directional Vedha rays.",
    whatIsIt:
      "Described in Saravali, Narapati Jayacharya, and modern empirical research. The 9x9 concentric matrix maps 28 Nakshatras (including Abhijit) and divides them into 112 Sukshmamshas (Pada-112). Planets cast Front (Direct), Left, and Right Vedha rays depending on their direct vs retrograde motion.",
    howToUse: [
      "Navigate to Sarvatobhadra Chakra (SBC) under Predictive Analysis.",
      "Select your Janma Nakshatra and exact Pada to highlight your natal anchor points (7 Tatvas & 10 Sangyas).",
      "Click any outer cell on the 9x9 grid to trace its three Vedha lines (Green=Front, Blue=Left, Red=Right).",
      "Inspect the 112 Sukshmamsha indicator: check if a transiting planet occupies an Auspicious amsha (Dhanāṁśa, Rājyāṁśa, Utkṛṣṭāṁśa, Saukhyāṁśa) or an Inauspicious amsha (Pāpāṁśa, Dāridryāṁśa, Krodhāṁśa, Taskarāṁśa).",
      "Use Date Scans to pinpoint exact dates when benefic Vedha hits occur.",
    ],
    keyInputs: ["Reference Nakshatra & Pada (Janma, Karma, Adhana, etc.)", "Transit Date & Planetary Speeds."],
    howToInterpret: [
      "Auspicious Sukshmamsha Vedha (धनांश, राज्यांश, सौख्यांश): Significant elevation, career breakthroughs, power acquisition, wealth gains, and miraculous protection.",
      "Inauspicious Sukshmamsha Vedha (पापांश, दारिद्र्यांश, क्रोधांश, तस्करांश): Severe crisis, legal entanglements, financial reversals, or sudden health vulnerabilities.",
      "Retrograde Planets: Cast reversed Left/Right rays with amplified intensity.",
    ],
    proTip: "Combine SBC Vedha with Latta Dosha (Phaladeepika Ch. XXVI) and Tarabala for high-probability predictive confluence.",
  },
  {
    id: "unified-event-timing",
    title: "Unified Event Timing & Sensitive Timelines",
    category: "predictive",
    categoryLabel: "Predictive & Timing",
    route: "/timing",
    icon: "clock",
    tagline: "Triple-filter convergence engine (SBC Vedha + Latta Dosha + 27-Tara) for past verification & future alerts.",
    whatIsIt:
      "A dedicated timeline scanner that identifies sensitive windows by requiring multi-technique agreement (>=3 independent classical techniques must agree for a high-confidence YES verdict).",
    howToUse: [
      "Open Unified Event Timing (/timing) from the sidebar.",
      "Select your active natal chart or input birth coordinates.",
      "Set your research scan window (past range to verify known events, or future range for forward alerts).",
      "Inspect the Convergence Score and Technique Indicators for each flagged window.",
    ],
    keyInputs: ["Natal Chart", "Scan Window Date Range", "Convergence Threshold (Default: 3 Techniques)."],
    howToInterpret: [
      "YES Verdict (3+ Techniques Agree): High-probability turning point (promotions, crises, major relocations, financial leaps).",
      "NO Verdict (<3 Techniques): Sub-threshold fluctuations that rarely produce major life milestones.",
    ],
    proTip: "Use this module to backtest your past life events (examinations, marriages, job changes) to calibrate your chart's sensitivity.",
  },
  {
    id: "tarabala-module",
