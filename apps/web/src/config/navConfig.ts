...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/research/categories", label: "Category Tree", icon: "grid" },
      { href: "/research/event-types", label: "Event Tree", icon: "grid" },
      { href: "/research/cases/bulk-import", label: "Bulk Import", icon: "document" },
