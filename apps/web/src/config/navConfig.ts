...
export const NAV_CONFIG: NavGroup[] = [
  {
    ...
    modules: [
      ...
      },
      {
        ...
        color: "--section-charts",
        items: [
          { href: "/charts/kundli", label: "Interactive Kundli", subtitle: "Birth chart visualization", icon: "compass", viewId: "workspace-kundli" },
          { href: "/charts/birth", label: "Chart View", subtitle: "Planetary detail panels", icon: "chart", viewId: "workspace-chart" },
          { href: "/charts/planets", label: "Planet Explorer", icon: "search" },
          { href: "/charts/houses", label: "House Explorer", subtitle: "Bhava analysis", icon: "house", viewId: "workspace-houses" },
          { href: "/charts/divisional", label: "Divisional Charts", subtitle: "D-1 through D-60", icon: "grid", viewId: "workspace-divisional" },
          { href: "/charts/relationships", label: "Planet Relationships", subtitle: "Aspect graph", icon: "network", viewId: "workspace-relationships-v2" },
        ],
      },
      {
        id: "nakshatra",
    ...
    modules: [
      {
        ...
        items: [
          ...
          { href: "/charts/timeline", label: "Transit", subtitle: "Current planetary positions", icon: "orbit", viewId: "analysis-transit" },
          { href: "/charts/yogas", label: "Yogas", icon: "star" },
          { href: "/charts/ashtakavarga", label: "Ashtakavarga", icon: "grid" },
          { href: "/charts/strength", label: "Shadbala", subtitle: "Planet strength", icon: "bar", viewId: "analysis-shadbala" },
      ...
      },
      {
        ...
        color: "--section-analysis",
        items: [
          { href: "/charts/kp", label: "KP Analysis", subtitle: "Krishnamurti Paddhati", icon: "target", viewId: "analysis-kp" },
          { href: "/charts/jaimini", label: "Jaimini", icon: "book" },
    ...
    modules: [
      ...
      },
      {
        ...
        items: [
          ...
          { href: "/settings/theme", label: "Theme", icon: "palette", viewId: "settings-theme" },
          { href: "/settings/security", label: "Security", icon: "shield", viewId: "settings-security" },
          { href: "/settings/preferences", label: "Preferences", icon: "settings", viewId: "settings-preferences" },
        ],
      },
      {
        id: "admin",
...
export const NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: "/charts/import", label: "Import Chart", icon: "upload" },
      { href: "/charts/birth", label: "Birth Chart", icon: "compass" },
      { href: "/charts/divisional", label: "Divisional Charts", icon: "grid" },
      { href: "/charts/relationships", label: "Planet Relationship Graph", icon: "network" },
      { href: "/charts/houses", label: "House Dependency", icon: "network" },
  ...
  },
  {
    ...
    color: "--section-analysis",
    items: [
      { href: "/charts/dasha", label: "Dasha Analysis", icon: "clock" },
      { href: "/charts/transit", label: "Transit Analysis", icon: "orbit" },
      { href: "/charts/sbc", label: "Sarvatobhadra Chakra", icon: "grid" },
      { href: "/charts/tarabala", label: "Navatara / Tarabala", icon: "star" },
      { href: "/charts/yogas", label: "Yogas & Combinations", icon: "star" },
      { href: "/charts/ashtakavarga", label: "Ashtakavarga", icon: "grid" },
      { href: "/charts/strength", label: "Shadbala", icon: "bar" },
      { href: "/charts/kp", label: "KP Analysis", icon: "target" },
      { href: "/charts/jaimini", label: "Jaimini Analysis", icon: "book" },
      { href: "/predictions", label: "Prediction Chain Explorer", icon: "sparkle" },
    ],
  },
  {
